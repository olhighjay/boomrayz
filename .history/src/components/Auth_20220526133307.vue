      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden
        ...
        <div class="py-4 text-left px-6">
          ...
          @submit="login">
            ...
            <div class="mb-3">
              <label for="loginemail" class="inline-block w-full mb-2">Email</label>
                <vee-field id="loginemail" type="email" name="loginEmail"
                class="block py-1.5 px-3 text-gray-800 w-full border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded"
                placeholder="Enter Email" />
              <ErrorMessage class="text-red-600" name="loginEmail" />
            </div>
            <!-- Password -->
            <div class="mb-3">
              <label for="loginpass" class="inline-block w-full mb-2">Password</label>
                <vee-field type="password" id="loginpass" name="loginPassword"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded"
                placeholder="Password" />
              <ErrorMessage class="text-red-600" name="loginPassword" />
            </div>
            <button type="submit"
          ...
          @submit="register" :initial-values="userData">
            ...
            <!-- Email -->
            <div class="mb-3">
              <label for="email" class="inline-block w-full mb-2">Email</label>
            ...
            <!-- Age -->
            <div class="mb-3">
              <label for="age" class="inline-block w-full mb-2">Age</label>
